...
public class Esercizio1Main {
	...
	public static void stampaDueRettangoli(int _primoPerimetro, int _primaArea, int _secondoPerimetro, int _secondaArea, int _sommaPerimetri, int _sommaAree) {
		System.out.println("Perimetro primo rettangolo: " + _primoPerimetro + ", Area primo rettangolo: " + _primaArea);
		System.out.println("Perimetro secondo rettangolo: " + _secondoPerimetro + ", Area secondo rettangolo: " + _secondaArea);
